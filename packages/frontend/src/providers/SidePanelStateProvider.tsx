...
export const useSidePanelState = () => useContext(sidePanelStateCtx);

export const useSidePanelDispatcher = () => useContext(sidePanelDispatcherCtx);

export const useSidePanelVisible = () => useSidePanelState().visible;
...
export const useHoldSidePanel = () => useCallback(() => {
  window.clearTimeout(sidePanelControl);
}, []);
